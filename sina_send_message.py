...
def login(driver, wait):
    ...
    wait.until(EC.presence_of_element_located((By.ID, 'loginname'))).send_keys(username)
...
if __name__ == "__main__":
    driver = DriverFactoty.create_driver()
    ...
    for uid in fp:
        ...
        sleep(3) # 避免發訊息過快
        try:
            wait.until(EC.presence_of_element_located((By.XPATH, '//textarea'))).send_keys(what_to_say + Keys.ENTER)
